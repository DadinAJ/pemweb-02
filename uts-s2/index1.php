        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                        <a  href="index.php"><i class="nav-icon fas fa-th"></i> Home</a>
                        <a  href="index1.php?halaman=produk"><i class="nav-icon fas fa-th"></i> Produk</a>
                        <a  href="index1.php?halaman=pesanan"><i class="nav-icon fas fa-th"></i> Pesanan</a>
